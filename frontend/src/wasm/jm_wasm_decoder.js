/* @ts-self-types="./jm_wasm_decoder.d.ts" */
...
export class DecodeResult {
     ...
     */
    get pixels() {
        const ret = wasm.decoderesult_pixels(this.__wbg_ptr);
 ...
 */
export function descramble(data, num) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.descramble(ptr0, len0, num);
    if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('jm_wasm_decoder_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
